# RailsAdmin config file. Generated on June 14, 2012 18:23
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = [Company, Contact, Employee, Favorite, Location, OpportunityType, Profile, Region, RegionType]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Company, Contact, Employee, Favorite, Location, OpportunityType, Profile, Region, RegionType]
  ...
  #     configure :hg_location_id, :integer 
  ...
  #     configure :_id, :bson_object_id 
  #     configure :company_id, :integer 
  #     configure :profile_id, :integer   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :country, :text   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
