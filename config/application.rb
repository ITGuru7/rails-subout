...
module Subout
  class Application < Rails::Application
    ...
    config.mongoid.observers = :bid_observer, :company_observer, :event_observer, :opportunity_observer, :vehicle_observer, :gateway_subscription_observer, :quote_request_observer
