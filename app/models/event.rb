class Event
  ...
  def as_json(options={})
    ...
    json_attributes[:eventable] = self.eventable.as_json(:methods => [:winning_bid_amount, :type, :formatted_amount, :opportunity_title, :opportunity_bidding_ends, :bids_count, :latest_bid_amount, :lowest_bid_amount] )
